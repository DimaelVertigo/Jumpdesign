...
class ffPluginWienCore extends ffPluginAbstract {
	/**
	 *
	 * @var ffPluginWienCoreContainer
	 */
	...
	protected function _run() {
        ...
        require dirname( dirname( __FILE__ ) ).'/components/vc_shortcodes/vc_wien_shortcodes.php';
