...
class ffThemeContainer extends ffThemeContainerAbstract {
	...
	const OPTIONS_NAMESPACE = 'theme_wien';
	const OPTIONS_NAME      = 'theme_options';
	const THEME_NAME_LOW = 'wien';


	/**
	 * @var ffThemeOxygenContainer
	 */
	...
	protected function _registerFiles() {
		...
		$this->_registerThemeFile( 'ffWidgetRecentPosts', '/framework/components/widgets/recentPosts/class.ffWidgetRecentPosts.php');
		$this->_registerThemeFile( 'ffComponent_RecentPostsWidget_OptionsHolder', '/framework/components/widgets/recentPosts/class.ffComponent_RecentPostsWidget_OptionsHolder.php');
		$this->_registerThemeFile( 'ffComponent_RecentPostsWidget_Printer', '/framework/components/widgets/recentPosts/class.ffComponent_RecentPostsWidget_Printer.php');
