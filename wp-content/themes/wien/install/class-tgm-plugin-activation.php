	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			$this->strings = array(
				...
				'install_link'                    => _n_noop('Begin installing plugin','Begin installing plugins','default'),
				'update_link'                     => _n_noop('Begin updating plugin','Begin updating plugins','default'),
				'activate_link'                   => _n_noop('Begin activating plugin','Begin activating plugins','default'),
		...
		protected function add_admin_menu( array $args ) {
			...
			if ( 'themes.php' === $this->parent_slug ) {
				...
				$this->page_hook = call_user_func( 'add' . '_' . 'submenu' . '_' . 'page', $args['parent_slug'], $args['page_title'], $args['menu_title'], $args['capability'], $args['menu_slug'], $args['function'] );
			}
		}
