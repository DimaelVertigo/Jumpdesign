...
$s->startSection('contact-form-2', ffOneSection::TYPE_REPEATABLE_VARIATION)
	->addParam('section-name', __('Contact Form 2', 'wien'))
	...
	$s->addElement( ffOneElement::TYPE_TABLE_START );
		...
		$s->addElement( ffOneElement::TYPE_TABLE_DATA_START, '', __('Title', 'wien'));
			$s->addOption(ffOneOption::TYPE_TEXT, 'title', __('Title', 'wien'), __('Get in touch', 'wien'));
		$s->addElement( ffOneElement::TYPE_TABLE_DATA_END );

		$s->startSection('map');
			$s->addElement( ffOneElement::TYPE_TABLE_DATA_START, '', __('Map', 'wien'));
		...
		$s->addElement( ffOneElement::TYPE_TABLE_DATA_START, '', __('Description', 'wien'));
			$s->startSection('description');
				...
				$s->addOption( ffOneOption::TYPE_TEXT, 'text', __('Text', 'wien'), __('support@wien.com', 'wien'));
				$s->endSection();
				$s->endSection();
				$s->endSection();
				$s->endSection();
