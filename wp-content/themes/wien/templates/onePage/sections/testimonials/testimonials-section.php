...
$s->startSection('testimonials', ffOneSection::TYPE_REPEATABLE_VARIATION)
    ->addParam('section-name', __('Testimonials', 'wien'))
    ...
    $s->addElement( ffOneElement::TYPE_TABLE_START );
        ...
        $s->addElement( ffOneElement::TYPE_TABLE_DATA_START, '', __('Testimonials', 'wien'));
            $s->startSection('testimonials', ffOneSection::TYPE_REPEATABLE_VARIABLE);
                ...
                $s->addElement(ffOneElement::TYPE_NEW_LINE);
                $s->addOption(ffOneOption::TYPE_TEXT, 'company', __('Company', 'wien'), __('Company name Inc', 'wien'));
                $s->addElement(ffOneElement::TYPE_NEW_LINE);
                $s->addOption(ffOneOption::TYPE_IMAGE, 'photo', __('Photo', 'wien'), '');
                $s->endSection();
            $s->endSection();
        $s->addElement( ffOneElement::TYPE_TABLE_DATA_END );
